...
import { cancelOrderAction } from "@/lib/orders/board-actions";
...
export function CancelOrderDialog({
  ...
  return (
    <Modal open={order !== null} onClose={handleClose} title={dict.cancelOrder}>
      {order && (
        <>
          <p className="mb-md text-[13.5px] text-on-surface-muted">{order.orderNumber}</p>
